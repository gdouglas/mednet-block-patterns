<!-- wp:group {"style":{"color":{"background":"#002145"}},"textColor":"white","className":"events_list"} -->
<div
    class="wp-block-group events_list has-white-color has-text-color has-background"
